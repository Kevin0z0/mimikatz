...
BYTE PTRN_WN11_23H2_LogonSessionList[] = { 0x33, 0xD2, 0x48, 0xF7, 0xF1, 0x8B, 0xFA, 0x48, 0x8D, 0x04, 0x7F, 0x48, 0xC1 };
KULL_M_PATCH_GENERIC LsaSrvReferences[] = {
	...
	{KULL_M_WIN_BUILD_11_23H2,  {sizeof(PTRN_WN11_23H2_LogonSessionList), PTRN_WN11_23H2_LogonSessionList},	{0, NULL}, {58,  -4}},
};
